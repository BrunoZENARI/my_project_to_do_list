 ...
 */
final class Version20230803132801 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE taches ADD createur_id INT NOT NULL, ADD priorite INT NOT NULL, DROP créateur_id, DROP priorité');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE taches ADD créateur_id INT NOT NULL, ADD priorité INT NOT NULL, DROP createur_id, DROP priorite');
